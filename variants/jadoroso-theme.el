...
;;;;; mingus
     ...
     `(org-document-title                        ((,class (:foreground ,prim2 :weight bold :height ,(if jadoroso-org-height 1.3 1.0) :underline t))))
     ...
     `(org-level-1                               ((,class (:background ,prim0 :foreground ,dark0 :height ,(if jadoroso-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:background ,prim2 :foreground ,dark0 :height ,(if jadoroso-org-height 1.1 1.0)))))
