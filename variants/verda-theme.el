...
;;;;; mingus
     ...
     `(org-document-title                        ((,class (:background ,dark0 :foreground ,prim2 :weight bold :height ,(if verda-org-height 1.3 1.0) :underline t))))
     ...
     `(org-level-1                               ((,class (:background ,neutral1 :foreground ,light0 :height ,(if verda-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:background ,prim2 :foreground ,light0 :height ,(if verda-org-height 1.1 1.0)))))
