...
(let* (;; variable pitch
    ...
    (custom-theme-set-faces
     ...
     `(font-lock-keyword-face                    ((,class (:foreground ,prim1 :weight bold))))
     ...
     `(font-latex-sectioning-4-face              ((,class (:inherit font-latex-sectioning-5-face
                                                                    :height ,verda-tex-height-110))))
     `(font-latex-sectioning-5-face              ((,class (:inherit ,verda-pitch :foreground ,prim1
                                                                    :weight bold))))
     ...
     `(helm-buffer-directory                     ((,class (:foreground ,dark0 :background ,prim1))))
     `(helm-buffer-file                          ((,class (:foreground ,dark1 :background ,prim1))))
     ...
     `(helm-ff-dotted-directory                  ((,class (:foreground ,light1 :background ,neutral1))))
     ...
     `(helm-ff-invalid-symlink                   ((,class (:foreground ,dark0 :background ,err))))
     ...
     ;; Js2
     `(js2-warning                               ((,class (:underline (:color ,prim1 :style wave)))))
     ...
     `(lui-irc-colors-fg-7-face                  ((,class (:foreground ,prim1))))
...
;;;;; mingus
     ...
     ;; Neotree
     `(neo-dir-link-face                         ((,class (:foreground ,prim1 :weight bold))))
     ...
     `(org-document-title                        ((,class (:foreground ,prim2 :weight bold :height ,(if verda-org-height 1.3 1.0) :underline t))))
     `(org-done                                  ((,class (:foreground ,prim2 :bold t :weight bold))))
     `(org-formula                               ((,class (:foreground ,prim1))))
     `(org-headline-done                         ((,class (:foreground ,prim2))))
     `(org-hide                                  ((,class (:foreground ,dark3))))
     `(org-level-1                               ((,class (:foreground ,neutral0 :height ,(if verda-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:foreground ,prim2 :height ,(if verda-org-height 1.1 1.0)))))
     ...
     `(org-scheduled-today                       ((,class (:foreground ,prim0 :height ,(if verda-org-height 1.1 1.0)))))
