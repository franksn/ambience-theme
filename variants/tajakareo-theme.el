;;; tajakareo-theme.el --- Red, green, and yellow like Thai curry.
...
(unless (>= emacs-major-version 24)
  (error "tajakareo requires Emacs 24 or later!"))

(deftheme tajakareo "Red, green, and yellow like Thai curry.")

(defgroup tajakareo nil
  "tajakareo options."
  :group 'faces)

(defcustom tajakareo-variable-pitch t
  "Use variable pitch for latex, markdown, or org-mode"
  :type 'boolean
  :group 'tajakareo)

(defcustom tajakareo-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'tajakareo)

(defcustom tajakareo-tex-height-90 0.9
  "Font size 90%"
  :type 'number
  :group 'tajakareo)

(defcustom tajakareo-tex-height-110 1.1
  "Font size 110%"
  :type 'number
  :group 'tajakareo)

(defcustom tajakareo-tex-height-120 1.2
  "Font size 120%"
  :type 'number
  :group 'tajakareo)

(defcustom tajakareo-tex-height-130 1.3
  "Font size 130%"
  :type 'number
  :group 'tajakareo)
...
(let* (;; variable pitch
    ...
    (custom-theme-set-faces
     ...
     `(font-latex-sectioning-4-face              ((,class (:inherit font-latex-sectioning-5-face
                                                                    :height ,tajakareo-tex-height-110))))
     `(font-latex-sectioning-5-face              ((,class (:inherit ,tajakareo-pitch :foreground ,prim1
                                                                    :weight bold))))
     `(font-latex-sedate-face                    ((,class (:foreground ,medium))))
     `(font-latex-slide-title-face               ((,class (:inherit (,tajakareo-pitch font-lock-type-face)
                                                                    :weight bold :height ,tajakareo-tex-height-130))))
     `(font-latex-string-face                    ((,class (:foreground ,prim2))))
     `(font-latex-subscript-face                 ((,class (:height ,tajakareo-tex-height-90))))
     `(font-latex-superscript-face               ((,class (:height ,tajakareo-tex-height-90))))
     ...
     `(helm-ff-dotted-directory                  ((,class (:foreground ,warn))))
...
;;;;; mingus
     ...
     ;; Org-mode
     `(org-agenda-date-today                     ((,class (:foreground ,light2 :slant italic :weight bold :height ,(if tajakareo-org-height 1.2 1.0)))))
     ...
     `(org-document-title                        ((,class (:foreground ,prim2 :weight bold :height ,(if tajakareo-org-height 1.3 1.0) :underline t))))
     `(org-done                                  ((,class (:background ,prim2 :foreground ,light0 :bold t :weight bold))))
     `(org-formula                               ((,class (:foreground ,prim1))))
     `(org-headline-done                         ((,class (:foreground ,prim2))))
     `(org-hide                                  ((,class (:foreground ,dark3))))
     `(org-level-1                               ((,class (:foreground ,prim0 :height ,(if tajakareo-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:foreground ,prim2 :height ,(if tajakareo-org-height 1.1 1.0)))))
     ...
     `(org-scheduled-today                       ((,class (:foreground ,prim0 :height ,(if tajakareo-org-height 1.1 1.0)))))
     ...
     `(org-mode-line-clock-overrun               ((,class (:foreground ,light2 :background ,neutral0))))
     ...
     ;; Smart-mode-line
     ;; use (setq sml/theme nil) to enable tajakareo for sml
