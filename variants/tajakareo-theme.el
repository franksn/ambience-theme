...
;;;;; mingus
     ...
     `(org-document-title                        ((,class (:background ,dark0 :foreground ,prim2 :weight bold :height ,(if tajakareo-org-height 1.3 1.0) :underline t))))
     `(org-done                                  ((,class (:background ,prim2 :foreground ,prim2 :bold t :weight bold))))
     `(org-formula                               ((,class (:foreground ,prim1))))
     `(org-headline-done                         ((,class (:foreground ,prim2))))
     `(org-hide                                  ((,class (:foreground ,dark3))))
     `(org-level-1                               ((,class (:background ,neutral1 :foreground ,light0 :height ,(if tajakareo-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:background ,prim2 :foreground ,light0 :height ,(if tajakareo-org-height 1.1 1.0)))))
